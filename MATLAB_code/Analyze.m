...
%%Stack
X25_Fx_Stack = [X25_T20_Fx;X25_T02_Fx;X25_T22_Fx;X25_Tm20_Fx;X25_T0m2_Fx;X25_Tm2m2_Fx];
X25_Fy_Stack = [X25_T20_Fy;X25_T02_Fy;X25_T22_Fy;X25_Tm20_Fy;X25_T0m2_Fy;X25_Tm2m2_Fy];
X25_Fx_Mea_Stack = [X25_T20_Fx_Mea;X25_T02_Fx_Mea;X25_T22_Fx_Mea;X25_Tm20_Fx_Mea;X25_T0m2_Fx_Mea;X25_Tm2m2_Fx_Mea];
X25_Fy_Mea_Stack = [X25_T20_Fy_Mea;X25_T02_Fy_Mea;X25_T22_Fy_Mea;X25_Tm20_Fy_Mea;X25_T0m2_Fy_Mea;X25_Tm2m2_Fy_Mea];
...
figure()
sgtitle("Fx X25")
for i = 1:length(X25_Fx_Stack)
    subplot(2,3,i)
    hold on
    plot(X25_Y,X25_Fx_Stack(i,:))
    plot(X25_Y,X25_Fx_Mea_Stack(i,:))
    hold off
...
figure()
sgtitle("Fy X25")
for i = 1:length(X25_Fy_Stack)
    subplot(2,3,i)
    hold on
    plot(X25_Y,X25_Fy_Stack(i,:))
    plot(X25_Y,X25_Fy_Mea_Stack(i,:))
    hold off
    legend(["Theory","Experiment"])
    title(T(i))
    xlabel("Y [cm]")
